...
async function doSearch() {
  ...
  let queryByAnimal = "name,brand,contractor_name";
  let queryByVideo = "animal_name,animal_brand,location,user_name,title";
  let queryByUser = "location,first_name,last_name";
  clearQueries();
  store.commit("search_", []);
